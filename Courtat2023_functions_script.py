...
def import_AGB31():
    ...
    # Black soldier fly was removed as it was not considered as a widely consumed food item and no serving size could be attributed to it (see main text)
